...
<body>
    ...
    <div class="container mt-5">
        <h2 class="mb-4">Editar Notas de <?php echo htmlspecialchars($nombre . ' ' . $apellido); ?></h2>
        <form method="POST" action="../private/editar_notas_logic.php" class="bg-light p-4 rounded shadow">
            ...
            <?php if (count($notas) > 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p class="text-danger">Este alumno no tiene notas registradas.</p>
            <?php endif; ?>
